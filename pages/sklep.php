                ...
                <div id="clientlogin">
                    ...
                    if (isset($_SESSION["userOK"])) {
                        ...
                        <form action="../loginForm.php" method="post">   
                            ...
                            <a href="rejestracja.php" style="color: #999999"><font size="2"><u>Rejestracja</u></font></a>
                        </form>
                    <?php }
                    ?>      
                </div>
            ...
            <div class="row1">
                <header id="header" class="hoc clear"> 
                    ...
                    <nav id="mainav" class="fl_right">
                        <ul class="clear">
                            <li><a href="/sklep/index.php">Start</a></li>
                            <li class="active"><a href="sklep.php">Sklep</a></li>
